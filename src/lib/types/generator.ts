 ...
 * the active destination(s) are chosen purely at runtime via the
 * `EVENTS_DESTINATION` env var (and per-destination credentials). Delivery is
 * never configured in `.apsorc`.
 */
