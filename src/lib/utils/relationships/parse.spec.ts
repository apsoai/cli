...
describe("parseRelationships", () => {
  ...
  describe("Mixed Relationship Types", () => {
    it("should correctly parse ManyToMany alongside other types", () => {
      ...
      expect(result.User).toContainEqual(
        expect.objectContaining({
          name: "Profile",
          type: "OneToOne",
          referenceName: "userProfile",
          biDirectional: true,
          join: false,
        })
      ); // Expect preserved camelCase
      expect(result.User).toContainEqual(
        expect.objectContaining({
          name: "Post",
          type: "OneToMany",
      ...
      expect(result.Profile).toContainEqual(
        expect.objectContaining({
          name: "User",
          type: "OneToOne",
          referenceName: "User", // PascalCase entity name
      ...
      expect(result.Post).toContainEqual(
        expect.objectContaining({
          name: "User",
          type: "ManyToOne",
          referenceName: "User", // PascalCase entity name
      ...
      expect(result.Role).toContainEqual(
        expect.objectContaining({
          name: "User",
          type: "ManyToMany",
          referenceName: "User",
...
describe("getRelationshipForTemplate", () => {
  ...
  describe("UUID Primary Key Support", () => {
    it("should populate referencedEntityPrimaryKeyType as uuid when referenced entity has uuid primary key", () => {
      ...
      const result = getRelationshipForTemplate(
        "Account",
        relationships,
        entities
      );
