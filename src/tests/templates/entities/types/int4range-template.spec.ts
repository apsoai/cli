  ...
  const testCases: TemplateTestCase[] = [
    {
      ...
      assertions: [
        ...
        {
          type: "contains",
          text: "to: (range: {lower: number, upper: number, lowerInclusive: boolean, upperInclusive: boolean}",
        },
        ...
        {
          type: "contains",
          text: "ageRange: {lower: number, upper: number, lowerInclusive: boolean, upperInclusive: boolean};",
        },
    ...
    },
    {
      ...
      assertions: [
        ...
        {
          type: "contains",
          text: "optionalRange: {lower: number, upper: number, lowerInclusive: boolean, upperInclusive: boolean};",
        },
      ],
    },
    {
      ...
      assertions: [
        ...
        {
          type: "contains",
          text: "valueRange: {lower: number, upper: number, lowerInclusive: boolean, upperInclusive: boolean};",
        },
      ],
    },
  ];
