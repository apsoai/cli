  ...
  const testCases: TemplateTestCase[] = [
    {
      ...
      assertions: [
        ...
        { type: 'contains', text: 'to: (polygon: { coordinates: Array<Array<{x: number, y: number}>> } | null) => {' },
        { type: 'contains', text: 'from: (pgPolygon: string | null) => {' },
        { type: 'contains', text: 'boundary: { coordinates: Array<Array<{ x: number, y: number }>> };' },
    ...
    },
    {
      ...
      assertions: [
        ...
        { type: 'contains', text: 'optionalBoundary: { coordinates: Array<Array<{ x: number, y: number }>> };' }
      ]
    },
    {
      ...
      assertions: [
        ...
        { type: 'contains', text: 'area: { coordinates: Array<Array<{ x: number, y: number }>> };' }
      ]
    }
  ];
